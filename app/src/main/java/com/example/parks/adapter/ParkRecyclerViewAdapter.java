...
import com.example.parks.ParksFragment;
...
public class ParkRecyclerViewAdapter extends RecyclerView.Adapter<ParkRecyclerViewAdapter.ViewHolder>{
    ...
    public ParkRecyclerViewAdapter(List<Park> parkList, ParksFragment parkClickListener) {
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            parkName = itemView.findViewById(R.id.rowname);
            parkType = itemView.findViewById(R.id.rowtype);
            parkState = itemView.findViewById(R.id.rowstate);
        ...
        public void onClick(View view) {
            Park curPark = parkList.get(getAdapterPosition());
            onParkClickListener.onParkClicked (curPark);
